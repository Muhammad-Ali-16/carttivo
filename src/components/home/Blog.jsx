    ...
    return (
        <section className="blog-main width-common h-auto flex justify-center relative z-2">
            <div className="content-main overflow-hidden py-10">
                ...
                <div className={`blog-cards-main grid grid-rows-1 grid-cols-1 md:grid-cols-2 gap-6`}>
                    {blogs.map((post, i) => (
                        <div
                            key={i}
                            className="card bg-white flex flex-col sm:flex-row w-full rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300"
                        >
                            {/* >----------------->Card-Img<---------------< */}
                            ...
                            {/* >----------------->Card-Content<---------------< */}
                            <div className="card-content flex flex-col justify-center gap-3 p-4 sm:w-3/5">
